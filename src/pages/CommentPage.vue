  ...
  <div class="table">
    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="evaluation" label="评论内容"></el-table-column>
        <el-table-column prop="menuName" label="点餐"></el-table-column>
        <el-table-column prop="picture" label="评价图片">
...
import { getAllComment, getUserOfId, deleteComment } from '../api/index'
