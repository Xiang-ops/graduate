  ...
  <div class="table">
    <div class="container">
      ...
      <el-table :data="data" border size="mini" style="width: 100%" ref="multipleTable" height="550px" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="menuSize" label="菜品规格" width="80" align="center"></el-table-column>
...
import { setMenu, updateMenuMsg, getAllMenu, deleteMenu, getAllMenuType } from '../api/index'
